...
import { serverConfigQueryOptions, serverSessionStateQueryOptions } from "../lib/serverReactQuery";
...
import { shouldShowSessionStatusStrip } from "../sessionStatus";
...
export default function Sidebar() {
  ...
  const { data: sessionState = null } = useQuery(serverSessionStateQueryOptions());
  ...
  return (
    <>
      ...
      <SidebarContent className="gap-0">
        {sessionState && shouldShowSessionStatusStrip(sessionState) ? (
          <SidebarGroup className="px-2 pt-2 pb-0">
            <SessionStatusStrip state={sessionState} />
          </SidebarGroup>
        ) : null}
