...
import { ServerConfigUpdatedPayload, ServerSessionStateUpdatedPayload } from "./server";
...
export const WS_CHANNELS = {
  ...
  serverSessionStateUpdated: "server.sessionStateUpdated",
} as const;
...
export interface WsPushPayloadByChannel {
  ...
  readonly [WS_CHANNELS.serverSessionStateUpdated]: typeof ServerSessionStateUpdatedPayload.Type;
...
export const WsPushServerSessionStateUpdated = makeWsPushSchema(
  WS_CHANNELS.serverSessionStateUpdated,
...
export const WsPush = Schema.Union([
  ...
  WsPushServerSessionStateUpdated,
  WsPushTerminalEvent,
